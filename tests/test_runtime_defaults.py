...
def test_isolated_installer_migrates_annotations_and_matches_manifest_sample(tmp_path):
    ...
    env.update({
        ...
        "CLAUDE_CONFIG_DIR": str(home / "claude-profile"),
    ...
    # Reinstall with no new value must preserve the model/profile settings.
    ...
    assert f'Environment="CLAUDE_CONFIG_DIR={home}/claude-profile"' in systemd_unit
    ...
    assert f"export CLAUDE_CONFIG_DIR={home}/claude-profile" in generated_env
    ...
    assert manifest["env"]["CLAUDE_CONFIG_DIR"] == f"{home}/claude-profile"
    ...
    normalized_env["CLAUDE_CONFIG_DIR"] = ""
