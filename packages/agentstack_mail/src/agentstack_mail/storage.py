...
async def emit_notification_signal(
    ...
    Args:
        ...
        project_key: Canonical project human_key. Written whenever given, so a
            local watcher can prove the recipient belongs to this project; the
            slug alone is not that proof.
